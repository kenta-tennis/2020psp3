...
72~74:探す値と比較対象の位置の値を比較し、一致していたらその時の位置を結果に入れる

88:比較対象の位置をリストの真ん中にする

92 93:そのときの位置を結果に入れる

97:リストの左端を比較対象の位置の一つ右にする

101:リストの右端を比較対象の位置の一つ左にする


## 出力結果

```
bb35319024@DESKTOP-N8LSJ1E MINGW64 ~/Desktop/2020psp3/k01 (develop)
$ ./k01.exe
